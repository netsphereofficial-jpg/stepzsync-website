  ...
  return (
    <section id="download" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 py-24 text-center">
        ...
        {/* App Store Badges */}
        <div className="flex justify-center gap-4 mb-12 animate-slide-up" style={{animationDelay: '0.6s'}}>
          <a href="#" className="bg-black border border-gray-700 rounded-xl px-6 py-3 flex items-center gap-3 hover:border-gray-500 transition-colors">
